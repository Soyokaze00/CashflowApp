...
const options = {
  ...
  background: {
    color:'white',
    fill: '#353535',  // رنگ بک‌گراند چارت (مثلاً خاکی روشن)
  },
  
  series: [
    {
      // direction: "vertical",  // تغییر به عمودی
    ...
    // },
      ...
      sectorSpacing: 0,
    //   strokeWidth: 0,  // حذف border
    //   borderWidth: 0,
      color:"white",
      fills: ['#a7a7a7', '#fba110', '#ffed32', '#a47012'],  // رنگ‌ها به ترتیب برای هر بخش چارت
      strokes:["#FFFFFF"],
...
const options4 = {
  ...
  data: [
    { month: "تیر", price: 28000, v: 25000, menDelta: 280000, womenDelta: 250000 },
    { month: "مرداد", price: 280000, v: 400000, menDelta: 280000, womenDelta: 400000 },
    { month: "شهریور", price: 320000, v: 30000, menDelta: 320000, womenDelta: 300000 },
